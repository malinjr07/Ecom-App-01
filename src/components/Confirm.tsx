...
import { confirmContent } from "@/static/contents/sidebar";
...
const Confirm = () => {
  ...
  let { locale } = router;
  const content: any = useTranslator(locale || "en", confirmContent);
  return (
    <section>
      <div className="container">
        ...
        <div className="mb-8">
          <div className="w-full bg-white text-center relative mt-7 md:mt-0 pt-14 pb-28 md:pb-[60px] lg:pb-10">
            <i className="fa-solid fa-circle-check text-[#65D442] text-[80px] leading-[80px]"></i>
            ...
            <p className="py-9 text-3xl leading-[44px] font-arabicLight">
              {content?.orderInfo} {content?.orderNum}
            </p>
            ...
            <div className="flex flex-row flex-wrap justify-center items-center gap-6 md:gap-[100px] pt-[42px] pb-[100px]">
              <Link href="/dashboard/my-orders" className="p-4 bg-black-primary text-white w-full md:w-40 rounded-md font-semibold flex justify-center items-center gap-2"><ShoppingBag fill="#fff" /> {content?.btnText}</Link>
              <Link href="/track-order" className="p-4 bg-black-primary text-white w-full md:w-40 rounded-md font-semibold flex justify-center items-center gap-2"><Track fill="#fff" /> {content?.btnText2}</Link>
              {/* <Button
