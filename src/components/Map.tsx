  ...
  return (
    <>
      <div className=' bg-white rounded-lg py-6'>
        ...
        {/* map page */}
        <div
          className={`mt-2 ${optionalAddress && 'hidden'} relative h-full mx-auto`}
        >
          <div className='relative px-2 mx-auto'>
            <div className='max-w-[552px] min-w-[350px] max-h-[500px] h-[380px] w-full md:h-[490px] rounded-lg z-10 mx-auto'>
              ...
              <button
                onClick={() => locatedMe()}
                className={`text-[#2B8DC5] flex items-center gap-1 space-x-1 p-3 rounded-full bg-white w-[137px] h-[44px] shadow-sm absolute bottom-4 right-4 lg:right-8 ${showSearchArea ? 'lg:-bottom-24' : 'lg:bottom-20'} z-20`}
              >
        ...
        {optionalAddress && (
          <div className='mt-2 p-2 lg:px-4 lg:flex lg:items-start lg:justify-between '>
